        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <Link href="/" className="flex items-center">
            ...
            <div className="flex space-x-4 mb-4">
              ...
              {/* Facebook */}
              <div className="text-black/80 hover:text-black transition-colors cursor-pointer" aria-label="Facebook">
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
              ...
              {/* Twitter */}
              <div className="text-black/80 hover:text-black transition-colors cursor-pointer" aria-label="Twitter">
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
              ...
              {/* YouTube */}
              <div className="text-black/80 hover:text-black transition-colors cursor-pointer" aria-label="YouTube">
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
          ...
          {/* Product & Services */}
          <div>
            <h3 className="text-xl font-bold mb-4">Product & Services</h3>
          ...
          {/* Support & Legal */}
          <div>
            <h3 className="text-xl font-bold mb-4">Support & Legal</h3>
            <ul className="space-y-2">
              <li>
                <Link
                  href="/support"
